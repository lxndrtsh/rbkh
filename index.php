...
<html lang="en-US" class="no-js">
	<head>
		...
		=============================================== -->
		<meta charset="utf-8">
		<title>Rebekah Hathaway | Kansas City Graphic Designer</title>
		...
		<link rel="stylesheet" href="css/designr-theme-purple.css">
		...
		<div id="main-nav" class="navbar navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<!-- ======= LOGO ========-->
					<a class="navbar-brand scrollto" href="#home">REBEKAH HATHAWAY<br><span>Graphic Designer</span></a>
		...
		<header id="home" class="jumbotron">
			...
			<div class="container">
				...
				<div class="message-box clearfix">
					...
					<div class="left-col">
						<p>I AM <span>REBEKAH</span><br/>and I'm a</p>
					</div>	
			...
			<div class="container">
				...
				<div class="row services scrollimation fade-left">
					...
					<div class="col-md-3 details">
						<p>Whether it's a User Interface, a printed brochure or even a 3D model for animated graphics, I've spent my life being an artist and designer. From a sketchpad to production, everything is designed with an artist's mind.</p>
					</div>
					<div class="col-md-3 text-center">
					...
					<div class="col-md-3 details">
						<p>Zuckerberg may have created Facebook, but I've trained to be an expert in reaching out to communities and individuals on all social media platforms. Just like SEO, the more people you interact with online, the more brand awareness you generate.</p>
					</div>
				</div><!--End row (top) -->
				...
				<div class="row services bottom-row scrollimation fade-right">
					...
					<div class="col-md-3 details col-md-pull-3">
						<p>The art of branding is complex. It requires a creative mind, with a knowledge of the company's needs. I take this complexity as an exciting challenge, and I love helping companies find an image that fits them.</p>
					</div>
					<div class="col-md-3 text-center  col-md-push-3">
						<h2>Social Media</h2>
					...
					<div class="col-md-3 details  col-md-pull-3">
						<p>Search Engine Optimization is a required tool a small business needs to compete on the internet. I've specifically helped companies optimize their search rankings. Watching a small business blossom gives me warm fuzzies.</p>
					</div>
				</div><!--End row (bottom)-->
		...
		<section id="twitter">
			<div class="container">
				<div class="row scrollimation fade-in">
					...
					<div class="col-sm-11">
						<div id="twitter-slider" class="flexslider" data-widget-id="580776423759073280" data-tweets-length="5">
		...
		<section  id="contact">
			...
			<div class="container">
				...
				<div class="row">
					...
					<form id="contact-form" class="col-sm-12 scrollimation fade-left" action="contact.php" method="post" novalidate>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-6 left-col">
						<h1 class="small-logo">Rebekah Hathaway<br><span>Graphic Designer</span></h1>
						<ul class="footer-nav">
